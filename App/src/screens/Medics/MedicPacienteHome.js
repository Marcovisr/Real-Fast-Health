            ...
            <ScrollView style={styles.Scroll}
                ...
                <View style={styles.Mid}>
                    ...
                    <View style={styles.Box}>
                        ...
                        <CrudInput placeholder={""} text={"Nome"} value={name}  />
                        <CrudInput placeholder={""} text={"CPF"} value={cpf} />
                        <CrudInput placeholder={""} text={"RG"} value={rg}  />
                        <CrudInput placeholder={""} text={"Data de nascimento"} value={DTnascimento} />
                        <CrudInput placeholder={""} text={"Telefone"} value={telefone} />
                        <CrudInput placeholder={""} text={"Contato de emergência"} value={cEmergencia}  />
                    </View>
                    <View style={styles.Box}>
                        <View style={styles.Title}>
                            <Text style={styles.texto}> Plano de Saúde</Text>
                        </View>
                        <CrudInput placeholder={""} text={"Nome Plano de Saúde"} value={nomePlanoSaude}  />
                        <CrudInput placeholder={""} text={"Número de cadastro"} value={numeroCadastro}  />
                        <CrudInput placeholder={""} text={"Validade do Plano de Saúde"} value={validadePlanoSaude}  />
                    ...
                    <View style={styles.Box}>
                        ...
                        <CrudInput placeholder={""} text={"Cep"} value={cep} /> 
                        <CrudInput placeholder={""} text={"Estado"} value={estado} />
                        <CrudInput placeholder={""} text={"Cidade"} value={cidade} />
                        <CrudInput placeholder={""} text={"Bairro"} value={bairro} />
                        <CrudInput placeholder={""} text={"Rua"} value={rua} /> 
                        <CrudInput placeholder={""} text={"Número da residência"} value={numeroResidencial} /> 
                        <CrudInput placeholder={""} text={"Complemento"} value={complemento} /> 
                    </View>
                    <View style={styles.Box}>
                        <View style={styles.Title}>
